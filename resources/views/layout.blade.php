                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav flex-column">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-2" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ route('stats.age') }}">Effectif par tranche d'âge</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ route('stats.region') }}">Effectif par région d'origine</a>
                                            </li>
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-2" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link">Effectif par tranche d'âge</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link">Effectif par région d'origine</a>
                                            </li>
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2">
                                        <i class="fa fa-fw fa-rocket"></i> Suivi du parcours de l'étudiant
                                    </a>
                                </li>
                            </ul>
                        </div>
